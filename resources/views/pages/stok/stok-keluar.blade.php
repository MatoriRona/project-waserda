    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Stok Keluar</a></li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('stok.keluar.index') }}" method="get" class="m-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered zero-configuration" id="stokKeluarTbl">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>User</th>
    ...
    <div class="modal fade" id="addModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                action="{{ route('stok.keluar.store') }}" method="post">
                    @csrf
    ...
    <div class="modal fade" id="editModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                action="{{ route('stok.keluar.update') }}" method="post">
                    @csrf
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            // $('#stokKeluarTbl').dataTable({
            //     ajax: `{{ route('datatables') }}?type=stok-keluar&user_id=${user_id}&barang_id=${barang_id}&date_start=${date_start}&date_end=${date_end}`,
            //     columns: [{
            //             data: 'DT_RowIndex',
            //             name: 'DT_RowIndex'
            //         },
                ...
                success: (res) => {
                    if (res.success) {
                        ...
                        if(barang){
                            ...
                            $("#addForm input[name=stok_keluar]").val(0);
                        }
                    } else {
                        Swal.fire({
