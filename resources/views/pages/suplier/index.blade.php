                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered zero-configuration" id="suplierTbl">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama</th>
    ...
    <div class="modal fade" id="editModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                action="{{ route('suplier.update') }}" method="post">
                    @csrf
...
@section('js')
    <script>
        $(document).ready(function() {
            $('#suplierTbl').dataTable({
                ajax: "{{ route('datatables') }}?type=suplier",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
        ...
        function editData(data){
            $("#editForm input[name=suplier_id]").val(data.id);
